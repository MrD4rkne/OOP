...
public class SimulationBuilder implements ISimulationDataProvider {
    ...
    throws InvalidDataException
    {
        ...
        for(String companyData : companiesData){
            ...
            Integer companyStartingPrice = tryParseInt(companyDataParts[1]);
    ...
    throws InvalidDataException
    {
        ...
        Integer startingFunds = tryParseInt(startingInfoData[0]);
        ...
        for(int i = 1; i < startingInfoData.length; i++){
            ...
            Integer startingStocksCount = tryParseInt(companyData[1]);
